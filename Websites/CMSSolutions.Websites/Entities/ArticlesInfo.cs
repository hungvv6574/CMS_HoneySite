...
namespace CMSSolutions.Websites.Entities
{
    ...
    public class ArticlesMapping : EntityTypeConfiguration<ArticlesInfo>, IEntityTypeConfiguration
    {
        ...
        public ArticlesMapping()
        {
            ...
            this.Property(m => m.BannerUrl).IsRequired().HasMaxLength(500);
            this.Property(m => m.Image).IsRequired().HasMaxLength(500);
            ...
            this.Property(m => m.RefId).IsRequired().HasMaxLength(500);
        }
    }
}

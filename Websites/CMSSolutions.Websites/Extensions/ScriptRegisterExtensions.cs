...
namespace CMSSolutions.Websites.Extensions
{
    public static class ScriptRegisterExtensions
    {
        ...
        public static void IncludeAccounting(this ScriptRegister register)
        {
            register.Include("accounting/accounting.min.js");
        }

        public static void IncludeJssorSlider(this ScriptRegister register)
        {
            register.Include("jssorslider/jssor.slider.min.js");
        }
        ...
        public static void IncludeKnockout(this ScriptRegister register)
        {
            ...
            register.Include("knockout/knockout.validation.vi-VN.js");
